<template>
    <section class="container mx-auto mt-20">
        <div class="grid grid-cols-2 gap-4 items-center" v-if="mediaFirst">
            <div>
                <p
                class="mb-4 font-extrabold tracking-tight leading-none text-gray-900 dark:text-white"
                >
                {{ subTitle }}
                </p>
                <h1
        ...
        <div class="grid grid-cols-2 gap-4 items-center" v-else>
            ...
            <div>
                <p class="mb-4 font-extrabold tracking-tight leading-none text-gray-900 dark:text-white">{{ subTitle }}</p>
                ...
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">{{ description }}</p>
